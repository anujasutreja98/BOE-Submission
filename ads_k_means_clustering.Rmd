...
#SCR
ggplot(final_dataset_1, aes(x=SCR)) + geom_histogram(binwidth = 3000) +
  theme_classic() + ggtitle("Histogram SCR")

ggplot(final_dataset_1,aes(x=SCR))+geom_boxplot()+ggtitle("Distribution of SCR")+ylab("Count")
